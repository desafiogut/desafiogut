...
export default function CardLance({ idEdicao, tipoLeilao, encerrado }) {
  return (
    <div data-stub="card-lance" data-id-edicao={idEdicao} data-tipo={tipoLeilao} data-encerrado={String(encerrado)}>
      formulário de lance
    </div>
  );
}
