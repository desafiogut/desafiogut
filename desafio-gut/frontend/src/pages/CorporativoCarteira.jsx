          ...
          <div style={{ ...card, borderColor: "rgba(16,185,129,0.28)" }}>
            ...
            <div style={{ display: "flex", gap: "0.6rem", alignItems: "center", flexWrap: "wrap" }}>
              <input type="number" min={1} max={Math.max(1, saldoTroco)} value={qtdConv}
                ...
                style={{ width: "5rem", padding: "0.5rem", background: "rgba(255,255,255, var(--glass-opacity, 0.03))", border: "1px solid rgba(245,166,35,0.3)", borderRadius: "8px", color: "#e8f0fe", textAlign: "center", fontWeight: 700 }}
          ...
          <div style={card}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "0.6rem" }}>
              {COTAS.map((c) => (
                <button key={c.id} onClick={() => setTier(c)} style={{
                  ...
                  background: tier?.id === c.id ? "rgba(245,166,35,0.12)" : "rgba(255,255,255, var(--glass-opacity, 0.03))",
            ...
            {tier && (
              <div style={{ marginTop: "0.8rem" }}>
                ...
                <input
                  ...
                  style={{ width: "100%", padding: "0.6rem 0.8rem", background: "rgba(255,255,255, var(--glass-opacity, 0.03))", border: "1px solid rgba(245,166,35,0.3)", borderRadius: "10px", color: "#e8f0fe", fontWeight: 700, outline: "none" }}
            ...
            {pedido?.qrCodeText && pagStatus !== "confirmado" && (
              <div style={{ marginTop: "0.8rem", padding: "0.8rem", borderRadius: "10px", background: "rgba(251,191,36,0.06)", border: "1px solid rgba(251,191,36,0.3)", fontSize: "0.78rem", color: "#e8f0fe", lineHeight: 1.6 }}>
                ...
                <div style={{ marginTop: "0.4rem", padding: "0.5rem", background: "rgba(255,255,255, var(--glass-opacity, 0.03))", borderRadius: "8px", fontFamily: "monospace", fontSize: "0.68rem", color: "#fbbf24", wordBreak: "break-all", maxHeight: "100px", overflowY: "auto" }}>
                  {pedido.qrCodeText}
                </div>
