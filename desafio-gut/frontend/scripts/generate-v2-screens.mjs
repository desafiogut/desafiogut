...
const outputDir = path.join(process.cwd(), 'public', 'assets', 'telas', 'v2');
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .kpi-icon {
      ...
      color: #ffa500;
      font-size: 18px;
      box-shadow: inset 0 0 10px rgba(255,165,0,0.12);
    }
    .kpi-label {
      font-size: 10px;
      text-transform: uppercase;
    ...
    .hero-row .hero-card {
      border-radius: 22px;
      background: linear-gradient(180deg, rgba(255,165,0,0.10), rgba(255,255,255,0.03));
      border: 1px solid rgba(255,165,0,0.18);
      padding: 18px;
      box-shadow: 0 0 28px rgba(255,165,0,0.10);
    }
    .hero-card strong {
      font-family: 'Bebas Neue', sans-serif;
      font-size: 28px;
    ...
    .bottom-nav {
      ...
      background: linear-gradient(180deg, rgba(0,16,32,0.8) 0%, #001020 100%);
    ...
    .confetti div {
      ...
      width: 10px;
      height: 24px;
      background: radial-gradient(circle, #ffa500, rgba(255,165,0,0.4));
      opacity: 0.8;
      transform: rotate(20deg);
      border-radius: 6px;
      box-shadow: 0 0 24px rgba(255,165,0,0.5);
    }
    .winner-screen {
      position: relative;
      width: 100%;
      ...
      align-items: center;
      padding: 28px;
      background: radial-gradient(circle at top, rgba(255,165,0,0.12), transparent 18%), linear-gradient(180deg, #000000 0%, #001020 100%);
    }
    .winner-frame {
      width: 100%;
      max-width: 340px;
      padding: 26px;
      border-radius: 28px;
      background: rgba(0,16,16,0.96);
      border: 1px solid rgba(255,165,0,0.28);
      box-shadow: 0 0 50px rgba(255,165,0,0.28);
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 18px;
    ...
    .winner-frame::before {
      ...
      inset: 0;
      border-radius: 28px;
      box-shadow: inset 0 0 80px rgba(255,165,0,0.18);
      pointer-events: none;
    }
    .winner-title {
      font-family: 'Bebas Neue', sans-serif;
    ...
    .prize-card {
      width: 100%;
      border-radius: 22px;
      background: linear-gradient(180deg, rgba(255,165,0,0.12), rgba(255,255,255,0.03));
    ...
    .glow-button {
      ...
      text-transform: uppercase;
      letter-spacing: 0.12em;
      box-shadow: 0 0 36px rgba(255,165,0,0.6);
      cursor: pointer;
      z-index: 1;
    }
    .countdown-screen {
      ...
      padding: 0;
      overflow: hidden;
      background: radial-gradient(circle at top, rgba(255,165,0,0.1), transparent 20%), #000000;
      position: relative;
    }
    .countdown-bg {
      position: absolute;
    ...
    .countdown-go {
      ...
      text-shadow: 0 0 40px rgba(255,165,0,0.45);
    }
    ...
    .onboarding-screen {
      ...
      align-items: center;
      padding: 32px 18px;
      background: linear-gradient(180deg, #000000 0%, #001020 100%);
      position: relative;
    }
    .brand-logo {
      font-family: 'Bebas Neue', sans-serif;
      ...
      text-transform: uppercase;
      text-shadow: 0 0 30px rgba(255,165,0,0.35);
    }
    .brand-logo::after {
      content: '';
      position: absolute;
    ...
    .login-btn {
      ...
      text-transform: uppercase;
      cursor: pointer;
      box-shadow: 0 10px 28px rgba(255,165,0,0.28);
    }
    .login-btn.google {
      background: linear-gradient(135deg, #ffa500 0%, #ff8c00 100%);
      color: #000000;
